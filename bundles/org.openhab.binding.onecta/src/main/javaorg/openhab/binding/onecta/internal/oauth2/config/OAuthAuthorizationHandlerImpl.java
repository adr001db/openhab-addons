...
public final class OAuthAuthorizationHandlerImpl implements OAuthAuthorizationHandler {
    ...
    @Override
    public synchronized void beginAuthorization(String clientId, String clientSecret,
            String handle) {
        ...
        this.oauthClientService = oauthFactory.createOAuthClientService(
        		handle, TOKEN_URL, AUTHORIZATION_URL, clientId, clientSecret,
                null, false);
        this.handle = handle;
        redirectUri = null;
        timer = null;
    ...
    public String getAccessToken(String handle) {
        OAuthClientService clientService = oauthFactory
                .getOAuthClientService(handle);
